<template>
    <div class="tableContainer">
        <div class="table-label">
            ...
            <span class="pageTitle">登录历史列表</span>
        </div>
        ...
        <div class='searchInput'>
            <div class="search-top">
                ...
                <Input style="width:auto" 
                    ...
                    clearable
                    @on-enter="clickSub"
                    @on-clear='getLoginHistoryList'
                    @on-change='getLoginHistoryList'
                />
                <Button type="primary" @click="getLoginHistoryList" icon="ios-search">查找</Button>
            </div>
        </div>

        <!-- 列表数据展示 -->
        <Table border :columns='columns' :data='loginHistoryList'>
...
export default {
    ...
    methods: {
        ...
        getLoginHistoryList(){
            axios({
                url: this.$store.state.UrlIP + "/admin/getAdminLogs",
                method: "get",
                params: {
