  ...
  <div :class="sfShow ? 'el-header-fixed' : 'el-header'" id="el-header">
    ...
    <div class="el-right">
      <div class="el-right-icon">
        <!-- 搜索按钮 -->
        <el-button icon="el-icon-search" @click="searchVal" class="btn">
        </el-button>
        ...
        <!-- 全屏 -->
        <template>
          <el-button v-if="!fullScreenShow" @click="fullScreen">
...
export default {
  ...
  data() {
    return {
      ...
      sfShow: false,
      recentLoginName: recentLoginName:localStorage.getItem('UserName'),,
      showIcon: true,
        ...
        .then(() => {
          axios({
            ...
            .then((res) => {
              ...
              localStorage.removeItem("roleID"); //退出成功之后，就从sessionStorage中移除该角色
